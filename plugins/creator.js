...
let name = await conn.getName(who)
 ...
 const ini = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot1 `, `🚫 Don't call me 🥺`, `⁨abiputrapratama34@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://github.com/AbiDev11`],
    [`'1(431)8161380'`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot2 `, `🚫 Don't call me 🥺`, `⁨abiputrapratama34@gmail.com`, `🇯🇵 Jepang`, `🚀 https://github.com/AbiDev11`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://github.com/AbiDev11`, `🤖 Dont Forget To Donate!`]
  ], fkontak)
